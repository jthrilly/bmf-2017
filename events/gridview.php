...
?>
	<div id="tec-content" class="grid">
		<div id='tec-events-calendar-header' class="clearfix">
			<h2 class="blogtitle"><?php _e('Upcoming Events', $spEvents->pluginDomain) ?></h2><br />
					<?php
		global $wp_query;
		...
		<a class="ical" href="<?php bloginfo('home'); ?>/?ical=<?php echo $tecCatObject->slug; ?>"><?php _e('iCal Import', $spEvents->pluginDomain) ?></a> | 
			<span class='tec-calendar-buttons'> 
				<a class='tec-button-off' href='<?php echo events_get_listview_link(); ?>'><?php _e('List View', $spEvents->pluginDomain)?></a> |
