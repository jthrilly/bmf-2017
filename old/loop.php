...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		<h2 class="blogtitle"><?php _e( 'Not Found', 'twentyten' ); ?></h2>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
					...
					<div class="blog">
				<div class="blogdate" ><?php $badass=the_date('d M','','', FALSE); $date=substr($badass,0,2); $month=substr($badass,-3); echo"<em>$date</em> $month"; ?></div>
				<div class="blogpost">
				
					<h2 class="blogtitle"><?php the_title(); ?></h2>
					<div class="author">-<?php  the_author(); ?> at <?php the_time() ?></div>					  
				<?php the_content(); ?>	
				<p><?php  the_tags(); ?></p>	
				</div>
				</div>
